...
public class SysAppController {
     ...
     * selectConfigTree
     */
    @PostMapping("/{appId}/database_config")
    public void saveAppDatabaseConfig(@PathVariable Long appId, @RequestBody Long[] ids) {
        appDatabaseConfigService.saveAppDatabaseConfig(appId, ids);
    }
